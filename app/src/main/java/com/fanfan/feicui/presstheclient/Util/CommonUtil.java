...
public class CommonUtil {
    ...
    public static final String SHART_USER_NAME="userName";
    //SharedPreferences 保存用户名密码
    public static final String SHART_USER_PWD="userPwd";
    //SharedPreferences 保存是否第一次登陆
    public static final String SHART_IS_FIRST_RUN="isFirstRun";
